...
# User.create(first_name: 'Lorra', last_name: 'n/a', email_address: 'laura@lorra.com', password: 'lalala')
# User.create(first_name: 'Michelle', last_name: 'Obama', email_address: 'michelleoh@michelleobama.com', password: 'lalala')
...
User.create(first_name: 'Laura', last_name: 'Nadolski', email_address: 'laura@laura.com', password: 'lalala')
...
IntersectionalityModel.create(name: 'August 2018 Model', note: 'This is my first model, wow-eee how cool', user_id: 1)
IntersectionalityModel.create(name: 'Draft Model', note: 'This is my first model, wow-eee how cool', user_id: 1)

Category.create(name: 'Gender', description: 'Gender is a spectrum.', intersectionality_model_id: 1)
Category.create(name: 'Class', description: 'Gender is a spectrum.', intersectionality_model_id: 1)
Category.create(name: 'Disability', description: 'Gender is a spectrum.', intersectionality_model_id: 1)

Category.create(name: 'Gender', description: 'Gender is a spectrum.', intersectionality_model_id: 2)
Category.create(name: 'Class', description: 'Gender is a spectrum.', intersectionality_model_id: 2)
Category.create(name: 'Disability', description: 'Gender is a spectrum.', intersectionality_model_id: 2)
Category.create(name: 'SES', description: 'Gender is a spectrum.', intersectionality_model_id: 2)

Category.create(name: 'Gender', description: 'Gender is a spectrum.', intersectionality_model_id: 3)
Category.create(name: 'Class', description: 'Gender is a spectrum.', intersectionality_model_id: 3)
Category.create(name: 'Disability', description: 'Gender is a spectrum.', intersectionality_model_id: 3)
Category.create(name: 'SES', description: 'Gender is a spectrum.', intersectionality_model_id: 3)
Category.create(name: 'Race', description: 'Gender is a spectrum.', intersectionality_model_id: 3)
Category.create(name: 'Education', description: 'Gender is a spectrum.', intersectionality_model_id: 3)
Category.create(name: 'Religion', description: 'Gender is a spectrum.', intersectionality_model_id: 3)
Category.create(name: 'Sexuality', description: 'Gender is a spectrum.', intersectionality_model_id: 3)
